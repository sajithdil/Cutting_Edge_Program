...
namespace SimpleGameLib
{
    ...
    public class MapInformation
    {
        ...
        public MapObject findMapObject(String id)
        {
            ...
            Log.getInstance().log("@Folder:WorldData, Class:MapInformation, Log Type: Error, Line No: 44, " + "MapInformation " + this.ToString() + " could not find the map item with alias " + id + " st " + System.Environment.StackTrace);
        ...
        {
            Log.getInstance().log("@Folder:WorldData, Class:MapInformation, Log Type: Program Run Log, Line No: 70, " + "MapInformation " + this.ToString() + " starting to load the map " + source);
            ...
            Log.getInstance().log("@Folder:WorldData, Class:MapInformation, Log Type: Program Run Log, Line No: 80, " + "MapInformation " + this.ToString() + " finished loading the map information from " + source);
