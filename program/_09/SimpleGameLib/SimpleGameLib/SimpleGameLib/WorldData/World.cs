...
namespace SimpleGameLib
{
    ...
    public class World
    {
        ...
        public void init()
        {
            Log.getInstance().log("@World loading world " + Name);
            eventMap.init(eventFile);
            map.init(mapFile);
            assets.init(assetFile);

            Log.getInstance().log("@World executing the world script : " + scriptFile);
            ...
            {
                Log.getInstance().log("@World no world script file entered");
            }

            Log.getInstance().log("@World finished executing the world script");
            Log.getInstance().log("@World finished loading the world " + Name);
        }
